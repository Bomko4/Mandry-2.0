...
TIME_SLOTS = [
    "10:00-11:00", "11:15-12:15", "12:30-13:30", "13:40-14:40",
    "14:50-15:50", "16:00-17:00", "17:10-18:10", "18:20-19:20", "19:30-20:30"
]
...
async def finalize_booking(message: types.Message, state: FSMContext, phone: str, client_name: str, data: dict):
    ...
    #await message.answer("Хочемо повідомити, що цих вихідних команда території організовує концерт. Вхід на територію в цей період буде коштувати згідно тарифів по концерту - 500 грн/субота та неділя; 200 грн - паркінг, якщо ви на авто.\nПроте для наших гостей працює ось така механіка і тоді заїзд стандартно - парковка 200 грн/авто, якщо пішки- безкоштовно.\nВам потрібно повідомити при вʼїзді, що у вас є бронювання на сапах і показати промокод. Надсилаємо вам промокод –\nmandrysupp220826 - субота \nmandrysupp230826 - неділя\nПокажіть його на охороні та отримайте браслет з нашим логотипом. Браслет - це саме перепустка до нашого простору \n\n❗️Браслет не дає доступу до концерту")
